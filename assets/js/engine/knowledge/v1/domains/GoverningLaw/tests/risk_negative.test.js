/**
 * Golden Test for CONCEPT_GOVERNINGLAW_RISK (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_GOVERNINGLAW_RISK');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_GOVERNINGLAW_RISK");
