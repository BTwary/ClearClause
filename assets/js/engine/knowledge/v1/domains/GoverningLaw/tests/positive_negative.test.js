/**
 * Golden Test for CONCEPT_GOVERNINGLAW_POSITIVE (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_GOVERNINGLAW_POSITIVE');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_GOVERNINGLAW_POSITIVE");
