/**
 * Golden Test for CONCEPT_LIABILITY_NEGOTIATION (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_LIABILITY_NEGOTIATION');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_LIABILITY_NEGOTIATION");
