/**
 * Golden Test for CONCEPT_LIABILITY_MISSING (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_LIABILITY_MISSING');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_LIABILITY_MISSING");
