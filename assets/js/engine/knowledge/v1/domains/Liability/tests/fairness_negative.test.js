/**
 * Golden Test for CONCEPT_LIABILITY_FAIRNESS (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_LIABILITY_FAIRNESS');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_LIABILITY_FAIRNESS");
