/**
 * Golden Test for CONCEPT_LIABILITY_PRESENT (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_LIABILITY_PRESENT');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_LIABILITY_PRESENT");
