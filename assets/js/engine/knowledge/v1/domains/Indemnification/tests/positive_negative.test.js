/**
 * Golden Test for CONCEPT_INDEMNIFICATION_POSITIVE (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_INDEMNIFICATION_POSITIVE');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_INDEMNIFICATION_POSITIVE");
