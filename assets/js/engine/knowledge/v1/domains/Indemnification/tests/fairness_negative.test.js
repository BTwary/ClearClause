/**
 * Golden Test for CONCEPT_INDEMNIFICATION_FAIRNESS (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_INDEMNIFICATION_FAIRNESS');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_INDEMNIFICATION_FAIRNESS");
