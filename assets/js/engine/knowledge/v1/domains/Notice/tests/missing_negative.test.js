/**
 * Golden Test for CONCEPT_NOTICE_MISSING (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_NOTICE_MISSING');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_NOTICE_MISSING");
