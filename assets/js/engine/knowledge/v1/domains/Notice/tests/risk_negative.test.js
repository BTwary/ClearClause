/**
 * Golden Test for CONCEPT_NOTICE_RISK (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_NOTICE_RISK');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_NOTICE_RISK");
