/**
 * Golden Test for CONCEPT_NOTICE_PRESENT (Negative Case)
...
async function runTest() {
    ...
    const finding = result.findings.find(f => f.rule === 'CONCEPT_NOTICE_PRESENT');
    
    assert.ok(!finding, "Expected to NOT find rule CONCEPT_NOTICE_PRESENT");
